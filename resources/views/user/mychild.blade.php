    ...
    <div class="wrapper">
        <div class="sidebar">
            ...
            <ul>
                ...
                <li><a href=""><i class="fas fa-chart-line icon"></i> Growth Chart</a></li>
                ...
                <div class="form-container">
                    ...
                    <form>
                        <div class="form-group">
                            ...
                            <input type="text" id="b_name" name="b_name" value="Jane Doe" readonly>
                        </div>
                        <div class="form-group">
                            <label for="bornPlace">Born Place</label>
                            <input type="text" id="address" name="address" value="General Hospital" readonly>
                        </div>
                        <div class="form-group">
                            <label for="babyAge">Baby's Age</label>
                            <input type="text" id="b_age" name="b_age" value="2" readonly>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="born_weight" name="born_weight" value="3.2 kg" readonly>
                        </div>
                        <div class="form-group">
                            <label for="birthDate">Birthday</label>
                            <input type="date" id="bdy" name="bdy" value="2022-01-01" readonly>
                        </div>
                    </form>
                </div>
                @yield('content')
